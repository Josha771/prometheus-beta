def compute_levenshtein_distance(str1: str, str2: str) -> int:
    ...
    Examples:
        >>> compute_levenshtein_distance('kitten', 'sitting')
        3
    ...
    # If either string is empty, distance is length of the other string
    if len(str1) == 0:
        return len(str2)
    if len(str2) == 0:
        return len(str1)
    ...
    # Rows represent characters of str1, columns represent characters of str2
    ...
    # Return the bottom-right cell which contains the Levenshtein distance
